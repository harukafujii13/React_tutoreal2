...
const Login = (props) => {
  ...
  const [emailState, dispatchEmail] = useReducer(emailReducer, {
    value: "",
    isValid: null, //initial state for the email input field in the useReducer hook
  }); //When the emailReducer function is called with an action, it will use the initial state object as the starting point for updating the state of the email input field.
